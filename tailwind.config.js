...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'glass-gradient': 'linear-gradient(45deg, rgba(59,130,246,0.1) 25%, transparent 25%, transparent 50%, rgba(59,130,246,0.1) 50%, rgba(59,130,246,0.1) 75%, transparent 75%, transparent)',
        'underwater-texture': 'linear-gradient(to bottom, rgba(8, 47, 73, 0.5), rgba(8, 47, 73, 0.8))',
      },
      keyframes: {
        'fade-up': {
          '0%': {
      ...
      animation: {
        ...
        closeContent: 'closeContent 0.5s ease-out forwards',
        slideUp: 'slideUp 0.5s ease-out forwards',
        slideUpExit: 'slideUpExit 0.3s ease-out forwards',
        slideDownEnter: 'slideDownEnter 0.3s ease-out forwards',
  ...
  plugins: [
    ...
    function ({ addUtilities }) {
      const newUtilities = {
        '.glass-effect': {
          '@apply backdrop-blur-2xl bg-white/15 border border-white/30': {},
        },
        '.glass-dark': {
        ...
        '.glass-blue': {
          '@apply bg-blue-900/30 backdrop-blur-2xl border-blue-300/10': {},
        ...
        '.glass-shine': {
          ...
          'animation': 'glass-shine 15s linear infinite',
        },
      }
